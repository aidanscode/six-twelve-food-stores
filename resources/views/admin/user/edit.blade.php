...
<div class="container mt-3">
  <div class="row">
    ...
    <div class="col-12 col-md-6">
      ...
      <button type="button" data-bs-toggle="modal" data-bs-target="#reset-password-modal" class="btn btn-dark float-md-end me-md-3">Reset Password</button>
    </div>
  </div>
...
<div class="modal fade" id="reset-password-modal" tabindex="-1" aria-labelledby="reset-password-modal-label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="reset-password-modal-label">Password Reset Confirmation</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Go Back</button>
        <form action="{{ route('user.reset_password', ['user' => $user]) }}" method="POST">
          @csrf
          <button type="submit" class="btn btn-danger">Confirm Password Reset</button>
        </form>
      </div>
    </div>
  </div>
