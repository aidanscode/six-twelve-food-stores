...
<div class="container overflow-hidden">
  ...
  <div>
	...
	<div id="accordion" class="mb-5">
		<div class="card">
			<div class="card-header" id="culture">
			  <h5 class="mb-0">
				<button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#culture_collapse" aria-expanded="true" aria-controls="culture_collapse">
				  Culture
				</button>
			  </h5>
			</div>
		...
		<div class="card">
			<div class="card-header" id="values">
			  <h5 class="mb-0">
				<button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#values_collapse" aria-expanded="false" aria-controls="values_collapse">
				  Our Values
				</button>
			  </h5>
			</div>
		...
		<div class="card">
			<div class="card-header" id="benefits">
			  <h5 class="mb-0">
				<button class="btn btn-link" data-bs-toggle="collapse" data-bs-target="#benefits_collapse" aria-expanded="false" aria-controls="benefits_collapse">
				  Benefits
				</button>
			  </h5>
			</div>
